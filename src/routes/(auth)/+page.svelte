...
<div class="min-h-screen flex flex-col items-center bg-neutral-900 text-white px-6 pt-32 pb-16">
    ...
    <p class="text-zinc-400 text-center max-w-xl mb-10 text-lg">
        A simple, no-BS calorie tracker that helps you stay consistent.
    ...
    <div class="mt-20 text-center max-w-3xl">
        ...
        <div class="grid md:grid-cols-3 gap-6 text-zinc-400">

            <div>
                <p class="font-semibold text-white mb-1">1. Create account</p>
                <p class="text-sm">Sign up and set your goals</p>
            </div>

            <div>
                <p class="font-semibold text-white mb-1">2. Log your meals</p>
                <p class="text-sm">Quickly track what you eat</p>
            </div>

            <div>
                <p class="font-semibold text-white mb-1">3. See progress</p>
                <p class="text-sm">Stay on track and improve daily</p>
            </div>
